  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-gray-100 text-gray-800">
      <div className="p-8 rounded-xl bg-white shadow-xl text-center max-w-md">
        ...
        <p><strong>Start Date:</strong> {formatDate(eventData.start_date)}</p>
        <p><strong>End Date:</strong> {formatDate(eventData.end_date)}</p>
        <p><strong>AO:</strong> {eventData.ao_name}</p>
        <p><strong>Backblast:</strong></p>
