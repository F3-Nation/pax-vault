            ...
            <div className="flex justify-between py-1 pb-2 border-b light:border-black/10 dark:border-white/10">
              <span className="text-primary">First Event:</span>
                ...
                {summary?.event_count === 0 ? (
                  ...
                  <>
                  {summary?.first_event_date}{" at "}
                  <Link
                    className="text-sm"
                    color="secondary"
                    href={`/stats/ao/${summary?.first_event_ao_id}`}
                  >
                    {summary?.first_event_ao_name ? summary?.first_event_ao_name : "Unknown AO"}
                  </Link>
                  </>
                )}
                </span>
            ...
            <div className="flex justify-between py-1 pb-2 border-b light:border-black/10 dark:border-white/10">
              ...
              <span>
                {summary?.event_count === 0 ? (
                  ...
                  <>
                  {summary?.last_event_date}{" at "}
                  <Link
                    className="text-sm"
                    color="secondary"
                    href={`/stats/ao/${summary?.last_event_ao_id}`}
                  >
                    {summary?.last_event_ao_name ? summary?.last_event_ao_name : "Unknown AO"}
                  </Link>
                  </>
                )}
                </span>
            ...
            <div className="flex justify-between py-1 pb-2 border-b light:border-black/10 dark:border-white/10">
              ...
              <span>
                {summary?.q_count === 0 ? (
                  ...
                  <>
                    {summary?.first_q_date}{" at "}
                    <Link
                      className="text-sm"
                      color="secondary"
                      href={`/stats/ao/${summary?.first_q_ao_id}`}
                    >
                      {summary?.first_q_ao_name ? summary?.first_q_ao_name : "Unknown AO"}
                    </Link>
                    </>
                )}
              </span>
            ...
            <div className="flex justify-between py-1 pb-2 border-b light:border-black/10 dark:border-white/10">
              ...
              <span>
                {summary?.q_count === 0 ? (
                  ...
                  <>
                    {summary?.last_q_date}{" at "}
                    <Link
                      className="text-sm"
                      color="secondary"
                      href={`/stats/ao/${summary?.last_q_ao_id}`}
                    >
                      {summary?.last_q_ao_name ? summary?.last_q_ao_name : "Unknown AO"}
                    </Link>
                    </>
                )}
              </span>
