    ...
    sections: [
      {
        tag: "Added",
        items: [
          '8 Box on your PAX page — the F3 vision board (Concentrica, 1st/2nd/3rd F, Jester, Mental Sharpness, Date Night, ALR), now in PAX Vault. Open your own PAX page and tap 8 Box, or use "Your 8 Box" in the menu.',
